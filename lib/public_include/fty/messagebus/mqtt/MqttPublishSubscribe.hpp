...
#include <fty/messagebus/ContainerPublishSubscribe.hpp>
...
{
  class MqttPublishSubscribe final : public ContainerPublishSubscribe, public fty::messagebus::mqttv5::MsgBusMqttWrapper, fty::messagebus::PublishSubscribe<Message>
  {
  public:
    MqttPublishSubscribe(const std::string& endpoint = DEFAULT_MQTT_END_POINT, const std::string& clientName = utils::getClientId("MqttPubSub"))
